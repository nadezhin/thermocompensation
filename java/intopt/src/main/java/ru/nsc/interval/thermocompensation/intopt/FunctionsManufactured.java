 ...
 *
 */
public class FunctionsManufactured {
    ...
    private static final Expression ZERO_TWO = list.interval("0", "2");
    private static final Expression p0 = list.interval("0", "1");
    private static final Expression p1 = ZERO_TWO;
    private static final Expression p2 = ZERO_TWO;
    private static final Expression p3 = ZERO_TWO;
    private static final Expression p4 = ZERO_TWO;
    private static final Expression p5 = ZERO_TWO;

    static final Expression xd = T.sub(INF);
    static final Expression xs = round(p0.add(xd.mul(SCALE)), 5);
    static final Expression pr2 = p1.add(K4.add(K5.mul(xs)));
    static final Expression res3 = K3.add(round(p2.add(pr2.mul(xs)), 10));
    static final Expression res4 = K2.add(round(p3.add(res3.mul(xs)), 10));
    static final Expression res5 = K1.add(roundBuggy(p4.add(res4.mul(xs)), 10));
    static final Expression res6 = K0.add(round(p5.add(res5.mul(xs)), 14));
